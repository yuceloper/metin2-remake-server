...
public ref struct PacketWriter
{
    ...
    public bool TryWriteSByte(sbyte value) =>
        TryWriteByte(unchecked((byte)value));

    public bool TryWriteUInt16LittleEndian(ushort value) =>
        TryWriteUInt16(value, littleEndian: true);

    public bool TryWriteUInt16BigEndian(ushort value) =>
        TryWriteUInt16(value, littleEndian: false);

    public bool TryWriteInt16LittleEndian(short value) =>
        TryWriteInt16(value, littleEndian: true);

    public bool TryWriteInt16BigEndian(short value) =>
        TryWriteInt16(value, littleEndian: false);

    public bool TryWriteUInt32LittleEndian(uint value) =>
        TryWriteUInt32(value, littleEndian: true);

    public bool TryWriteUInt32BigEndian(uint value) =>
        TryWriteUInt32(value, littleEndian: false);

    public bool TryWriteInt32LittleEndian(int value) =>
        TryWriteInt32(value, littleEndian: true);

    public bool TryWriteInt32BigEndian(int value) =>
        TryWriteInt32(value, littleEndian: false);

    public bool TryWriteUInt64LittleEndian(ulong value) =>
        TryWriteUInt64(value, littleEndian: true);

    public bool TryWriteUInt64BigEndian(ulong value) =>
        TryWriteUInt64(value, littleEndian: false);

    public bool TryWriteInt64LittleEndian(long value) =>
        TryWriteInt64(value, littleEndian: true);

    public bool TryWriteInt64BigEndian(long value) =>
        TryWriteInt64(value, littleEndian: false);

    public bool TryWriteSingleLittleEndian(float value) =>
        TryWriteInt32LittleEndian(BitConverter.SingleToInt32Bits(value));

    public bool TryWriteSingleBigEndian(float value) =>
        TryWriteInt32BigEndian(BitConverter.SingleToInt32Bits(value));

    public bool TryWriteDoubleLittleEndian(double value) =>
        TryWriteInt64LittleEndian(BitConverter.DoubleToInt64Bits(value));

    public bool TryWriteDoubleBigEndian(double value) =>
        TryWriteInt64BigEndian(BitConverter.DoubleToInt64Bits(value));

    public bool TryWriteBool8(bool value) =>
        TryWriteByte(value ? (byte)1 : (byte)0);
