...
internal static class PacketModelEmitter
{
    ...
    public static string Emit(PacketDefinition packet)
    {
        ...
        source.AppendLine();
        source.AppendLine(BuildDeclaration(packet) + ";");
        source.AppendLine();
        source.AppendLine($"public static class {packet.Name}Metadata");
        source.AppendLine("{");
        ...
        source.AppendLine($"    public const global::Metin2.Protocol.Generated.PacketPhase AllowedPhase = {MapPhase(packet.Phase)};");
